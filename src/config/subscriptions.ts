...
export type Tool = 'dashboard' | 'docs' | 'resume' | 'analyzer' | 'settings' | 'illustrations' | 'storage' | 'exam' | 'notes' | 'solver' | 'blueprint' | 'handwriting' | 'editor' | 'ai-assistant' | 'watermark-adder' | 'watermark-adder-compression';
