...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    // This effect runs after the component has mounted, preventing render-time state updates.
    if (user) {
      router.push('/');
    }
  }, [user, router]);
  ...
  // If user exists, this component will shortly redirect via useEffect.
  // We can render a loader or null to prevent the login form from flashing.
  if(user) {
    return (
            ...
            <CardFooter className="flex-col gap-4">
              ...
              <Button variant="outline" className="w-full" onClick={handleGoogleSignIn} disabled={loading}>
               ...
               <div className="relative w-full my-2">
                ...
                <Button variant="ghost" className="w-full text-muted-foreground" onClick={handleGuestAccess}>
