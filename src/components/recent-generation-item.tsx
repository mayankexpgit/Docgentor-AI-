...
import { FileText, User, ScanText, BarChartHorizontal, ClipboardPen, FileSignature, BookOpenCheck, DraftingCompass, PenSquare, FileEdit, Eye, Trash2 } from "lucide-react";
...
const getIcon = (type: AnyRecentGeneration['type']) => {
    switch (type) {
        ...
        case 'handwriting': return <PenSquare className="w-6 h-6 text-red-500" />;
        ...
        case 'illustrations': return <BarChartHorizontal className="w-6 h-6 text-teal-500" />;
