                                    ...
                                    render={({ field }) => (
                                        <FormItem className={cn(isTimetable && "hidden")}>
                                            <FormLabel
                                                ...
                                                onClick={() => {if (!isPremiumUser && field.value > 15) setSubscriptionModalOpen(true)}}
                                            >
                                                <BookOpen /> {isPresentation ? t('docgenSlidesLabel') : t('docgenPagesLabel')}: {field.value}
                                                {!isPremiumUser && field.value > 15 && (
                                            ...
                                            <FormControl>
                                             ...
                                             <FormDescription>
                                                Max pages: {isPremiumUser ? '30 (Premium)' : '15 (Freemium)'}.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className={cn(isTimetable && "hidden")}>
                                            <FormLabel
                                                className="flex items-center gap-2 cursor-pointer"
                                                onClick={() => {if (!isPremiumUser && field.value > 5) setSubscriptionModalOpen(true)}}
                                            >
                                                <ImageIcon /> {t('docgenImagesLabel')}: {field.value}
                                                {!isPremiumUser && field.value > 5 && (
                                                    <span className="text-xs font-medium text-yellow-600 flex items-center gap-1">
                                                        <Crown className="w-3 h-3"/> Premium
                                                    </span>
                                                )}
                                            ...
                                            <FormDescription>
                                                {t('docgenImagesDescription')} Max: {isPremiumUser ? '15 (Premium)' : '5 (Freemium)'}.
                                            </FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
